...
{/*=====================*/}
            ...
            {/*<div className={`btn  InfPosts center_center linkOneUser   ${fnShowBtn[1]}`}>   <Link className={'btnInfUser center_center '} to={{pathname:'/users_/'+item.id, state:item}} >!THE SECOND OPTION! Get more info about {item.name}</Link> </div>*/}
            {/*=====================*/}
